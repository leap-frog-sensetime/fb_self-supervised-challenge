...
from utils_dist.distributed_utils import dist_init, average_gradients, broadcast_params
...
def init_distributed_mode(args, make_communication_groups=True):
    ...
    # prepare distributed
    #dist.init_process_group(backend='nccl', init_method='env://10.5.38.31:24002',
    #                        world_size=args.world_size, rank=args.rank)
    dist_init('24002', backend='nccl')
