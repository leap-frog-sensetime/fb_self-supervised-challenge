...
def model_factory(sobel, relu=False, num_classes=0, batch_norm=True, syncbn=False, group_size=1, group=None, sync_stats=False):
    """
    Create a network.
    """
    ...
    body = VGG16(dim_in, relu=relu, batch_norm=batch_norm, syncbn=syncbn, group_size=group_size, group=group, sync_stats=sync_stats)
    # body = VGG19(dim_in, relu=relu, batch_norm=batch_norm, syncbn=syncbn, group_size=group_size, group=group,
